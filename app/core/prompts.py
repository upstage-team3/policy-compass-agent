...
- youth_policy는 정책명 부분일치 검색이므로 "청년", "정책", "지원", "사업"같은 범용어를 빼고
  핵심 주제어 1~2개만 남기세요.
- youth_policy 예: "청년 취업 지원" -> "취업", "거주 지원" -> "주거", "청년 월세 지원" -> "주거".
- RESPOND이면 null로 두세요.
...
한국어로 간결하고 친절하게 작성하고 이모지는 사용하지 마세요."""
...
검색어를 더 넓히거나 바꿀 수 있는 구체적인 다음 질문을 하나 제안하세요.
...
MISSING_SLOT_LABELS = {
    ...
    "age": "만 나이",
    "policy_topic": "관심 지원 분야(취업, 주거, 생활·복지 등)",
