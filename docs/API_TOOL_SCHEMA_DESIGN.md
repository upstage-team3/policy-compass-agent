...
| 나이 | 권장 | 청년정책 연령 조건 비교 |
| 취업 상태 | 일자리 정책에서 필수 | 미취업/재직/학생에 따라 일자리 정책이 달라짐 |
| 졸업 상태 | 권장 | 졸업예정/졸업 후 기간 조건 확인 |
| 관심 직무 | 필수에 가까움 | 훈련과정과 채용공고 검색의 핵심 조건 |
| 희망 근무지역 | 권장 | 채용정보 필터링 |
| 청년정책 분야 | 청년정책 검색에서 필수 | 일자리/주거/교육·직업·훈련/금융·복지·문화/참여·기반 중 검색 범위 결정 |
...
| 사용자 의도 | 호출 도구 |
| --- | --- |
| “지원금”, “청년정책”, “주거지원”, “복지”, “문화”, “참여”, “취업지원” | `YouthPolicySearchTool` |
| “내일배움카드”, “교육과정”, “직업훈련”, “강의”, “국비지원” | `TrainingCourseSearchTool` |
...
| Tool | 최소 조건 | 부족할 때 질문 |
| --- | --- | --- |
| `YouthPolicySearchTool` | 지역, 만 나이, 정책 분야. 일자리 분야는 취업 상태 추가 | “어느 지역 기준으로 찾아볼까요?”, “어떤 정책 분야를 찾으세요?”, 일자리일 때만 “현재 구직/재직/재학 중 어디에 가까우세요?” |
