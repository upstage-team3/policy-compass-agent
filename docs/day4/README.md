...
| Python 환경 | 준비 완료 | Python 3.11, Ruff lint/format, pytest `53 passed` |
...
2. SSE 상태 문구를 정책 추천·훈련과정·채용 정보·일반 설명 등 질문 유형별로 다르게 전송한다.
...
- [ ] 온통청년 실제 정책 응답과 내부 스키마 매핑 확인
- [ ] 고용24 훈련과정 실제 응답과 상세 URL 확인
- [ ] 고용24 채용 개인키 허용 endpoint 및 제한 fallback 확인
- [ ] 기업마당 실제 응답과 빈 필드·원문 링크 처리 확인
